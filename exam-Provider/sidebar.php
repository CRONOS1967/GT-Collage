<?php session_start(); 
   if (isset($_SESSION['role']) && $_SESSION['role'] == 'ec') {
    # code...
}else{
        ...
        <nav class="nav">
            <div>
                <a href="" class="nav__logo active">
                    ...
                    <span class="nav__logo-name">exam-commite dashbord</span>
                </a>

                <div class="nav__list">
                    <a href="mng-exam.php" class="nav__link ">
                        <i class='bx bx-merge'></i>
                        <span class="nav__name">Manage exam</span>
                    </a>
                    <a href="result.php" class="nav__link ">
                        <i class='bx bx-merge'></i>
                        <span class="nav__name">Student Results</span>
                    </a>
                   
                   
                    <a href="mng-q.php" class="nav__link">
                        <i class='bx bxs-report'></i>
                        <span class="nav__name">Manage Questions</span>
                    </a>
